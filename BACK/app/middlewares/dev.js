 ...
 */
 const dev = async (req, res, next) => {
    ...
    try {
      ...
      console.log(chalk.red.bold.bgYellow(`L'utilisateur ${req.session.user.pseudo} avec le role ${req.session.user.role} a bien été authentifié via le developper MW !`))
