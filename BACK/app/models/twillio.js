...
class Twillio {
    ...
    async save() {
        ...
        const {
            ...
            `INSERT INTO mada.twillio (quantite, created_date, id_produit) VALUES ($1, now(), $2) RETURNING *;`,
        ...
        consol.model(
            `la twillio id ${this.id} a été inséré à la date du ${this.createdDate} pour le produit id ${this.idProduit} !`
        );
    }
