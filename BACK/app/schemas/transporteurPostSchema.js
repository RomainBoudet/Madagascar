 ...
 */
const transporteurPostSchema = Joi.object({
    nom: Joi.string()
        .pattern(new RegExp(/^[^<>&#=+*/"|{}]*$/))
        .required()
        .max(200)
    ...
    logo: Joi.string()
        ...
        .messages({
            ...
            'any.required': 'Le champs de votre logo ne peut être vide !',

        }),

});

module.exports = transporteurPostSchema;
