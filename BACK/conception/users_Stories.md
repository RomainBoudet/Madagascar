...
| client non connecté     | Accéder aux différentes catégorie de produit vendue sur la page d'acceuil                                                          |
...
| client non connecté     |  * Pouvoir augmenter / diminuer le nombre de produit que je veux mettre dans mon pannier                                           |
| client non connecté     |  * Pouvoir ajouter des produits dans mon pannier                                                                                   |
...
| client non connecté     |  * Pouvoir continuer mes achats aprés avoir vu mon panier                                                                          |
| client non connecté     |  * Pouvoir commander aprés avoir vu mon panier  => qui m'enméne sur la page de connexion si pas cannecté                           |
| client non connecté     |  * Accéder a des catégories de produit sur la gauche de la page d'acceuil                                                          |
...
| client non connecté     | En bas de page, bandeau, Acceder sur les informations sur les livraisons                                                           |
| client non connecté     | En bas de page, bandeau, Acceder sur les informations sur les différent moyen de paiement                                          |
...
| client non connecté     | En bas de page, Accéder aux "Mentions légales"  (exemple bien fait racetools)                                                      |
...
| client connecté         |  * Pouvoir mettre a jour mes adresses de livaraison et de facturation directement durant la commande                                |
...
| client connecté         |  * Pouvoir cliquer sur "commander" aprés avoir adheré aux C.G.V. et choisir mon moyen de paiement                                  |
| client connecté         |  * Choisir mon moyen de paiement parmis : carte bancaire, paypal, virement bancaire                                                |
| client connecté         |  * Rentrer mes informations bancaires et valider le paiement                                                                        |
| client connecté         |  * Avoir un systéme de paiement sécurié via 3D secure avec un code a rentré via sms ou apli pour valider le paiement.                                                                       |
| client connecté         |  * Recevoir une confirmation de paiement bien effectué aprés le paiement                                                           |
| client connecté         |  * Recevoir un mail m'indiquant que ma commande a bien été pris en compte, avec la référence de ma commande, la date, le mode de paiement,  le/les produits, prix unitaire, quantité, prix total, le transporteur / mode de livraison, date estimé de de livraison, adresse de livraison et adresse de facturation                                                                                                                                                    |
...
| client connecté         | Accés a l'historique et aux détail de mes commandes (*) :                                                                          |
...
| client connecté         |   * Connaitre le nom de mon transporteur, le numéro du suivi, date, poid et frais d'expédition (racetools)                         |
| client connecté         |   * Ajouter un message en lien avec un produit préalablement commandé (racelub - racetool)                                         |
